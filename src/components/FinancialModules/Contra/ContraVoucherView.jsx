...
const ContraVoucherView = ({
  ...
  const handlePrintPDF = useCallback(() => {
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ${contraContent.innerHTML.replace(
  ...
  const entries = Array.isArray(selectedContra.entries) ? selectedContra.entries : [];
  const totals = {
    total: Number(selectedContra.totalAmount || selectedContra.amount || 0),
  };
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              <p style={{ margin: "2px 0" }}>
                Date: {new Date(selectedContra.date).toLocaleDateString("en-GB")}
              </p>
              <p style={{ margin: "2px 0" }}>
                Voucher No: {selectedContra.voucherNo}
              </p>
            </div>
          </div>
          <div
              ...
              <div>
                ...
                <div style={{ fontSize: "10px" }}>
                  <p style={{ margin: "2px 0" }}>
                    ...
                    {displayAccount(selectedContra.fromAccount)}
                  </p>
                  <p style={{ margin: "2px 0" }}>
                    <strong>To Account:</strong>{" "}
                    {displayAccount(selectedContra.toAccount)}
                  </p>
                  <p style={{ margin: "2px 0" }}>
